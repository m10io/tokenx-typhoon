...
In this tutorial, we'll network boot and provision a Kubernetes v1.12.0-alpha.1 cluster on bare-metal with Fedora Atomic.
...
module "bare-metal-mercury" {
  source = "git::https://github.com/poseidon/typhoon//bare-metal/fedora-atomic/kubernetes?ref=v1.12.0-alpha.1"
