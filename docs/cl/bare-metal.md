...
In this tutorial, we'll network boot and provision a Kubernetes v1.12.0-alpha.1 cluster on bare-metal with Container Linux.
...
module "bare-metal-mercury" {
  source = "git::https://github.com/poseidon/typhoon//bare-metal/container-linux/kubernetes?ref=v1.12.0-alpha.1"
...
```
# before v1.12.0-alpha.1
$ ssh debug@node1.example.com
# after v1.12.0-alpha.1
...
node1.example.com   Ready     11m       v1.12.0-alpha.1
node2.example.com   Ready     11m       v1.12.0-alpha.1
node3.example.com   Ready     11m       v1.12.0-alpha.1
```
